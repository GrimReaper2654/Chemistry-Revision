...
const ptable = [
    ...
    {name: ['Potassium','potassium'], symbol: ['K'], atomic: ['19'], mass: ['39.10','IDK'], valence: ['1','1+','+1','+'','IDK']},
    ...
    {name: ['Chromium','chromium'], symbol: ['Cr'], atomic: ['24'], mass: ['52.00','IDK'], valence: ['2+','2','+2','IDK']},
