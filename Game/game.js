...
const polyatomicIons = [
    ...
    [{question: 'Name:          ', answer: ['Acetate','acetate'], given: true},{question: 'Formula:       ', answer: ['CH3COO','C2H3O2'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Hypochlorite','hypochlorite'], given: true},{question: 'Formula:       ', answer: ['ClO'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[16][4].answer[0])*1+parseInt(ptable[7][4].answer[0]))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Chlorite','chlorite'], given: true},{question: 'Formula:       ', answer: ['ClO2'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[16][4].answer[0])+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Chlorate','chlorate'], given: true},{question: 'Formula:       ', answer: ['ClO3'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[16][4].answer[0])+parseInt(ptable[7][4].answer[0])*3))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Perchlorate','perchlorate'], given: true},{question: 'Formula:       ', answer: ['ClO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[16][4].answer[0])+parseInt(ptable[7][4].answer[0])*4))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Cyanate','cyanate'], given: true},{question: 'Formula:       ', answer: ['OCN'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[7][4].answer[0])+parseInt(ptable[5][4].answer[0])+parseInt(ptable[6][4].answer[0])))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Permanganate','permanganate'], given: true},{question: 'Formula:       ', answer: ['MnO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Dihydrogen phosphate','dihydrogen phosphate'], given: true},{question: 'Formula:       ', answer: ['H2PO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Hydrogen carbonate','hydrogen carbonate','Bicarbonate','bicarbonate'], given: true},{question: 'Formula:       ', answer: ['HCO3'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Hydrogen sulfate','hydrogen sulfate','Bisulfate','bisulfate'], given: true},{question: 'Formula:       ', answer: ['HSO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence:       ', answer: ['1-','1','-1','-'], given: false}],
    [{question: 'Name:          ', answer: ['Chromate','chromate'], given: true},{question: 'Formula:       ', answer: ['CrO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence: , answer: ['2-','2','-2'], given: false}],  
    [{question: 'Name:          ', answer: ['Dichromate','dichromate'], given: true},{question: 'Formula:       ', answer: ['Cr2O7'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence: , answer: ['2-','2','-2'], given: false}], 
    [{question: 'Name:          ', answer: ['Hydrogen phosphate','hydrogen phosphate'], given: true},{question: 'Formula:       ', answer: ['HPO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence: , answer: ['2-','2','-2'], given: false}], 
    [{question: 'Name:          ', answer: ['Peroxide','peroxide'], given: true},{question: 'Formula:       ', answer: ['O2'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence: , answer: ['2-','2','-2'], given: false}], 
    [{question: 'Name:          ', answer: ['Phosphate','phosphate'], given: true},{question: 'Formula:       ', answer: ['PO4'], given: true},{question: 'Molar mass:    ', answer: [JSON.stringify(parseInt(ptable[5][4].answer[0])*2+parseInt(ptable[0][4].answer[0])*3+parseInt(ptable[7][4].answer[0])*2))], given: false},{question: 'Valence: , answer: ['3-','3','-3'], given: false}],
];
